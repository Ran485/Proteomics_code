...
def read_file(file, Protein_Qvalue=True, usecols=0):
    """
    ...
    try:
        ...
        if Protein_Qvalue:
            ...
            df = df[~df["Genes"].str.startswith("rev")]
        else:
